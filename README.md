[GitHub pages preview](https://sophiavf.github.io/Project-Sign-Up-Form/)
...
<br />
<div align="center">
  <a href="https://github.com/sophiavf/Project-Sign-Up-Form">
    <span class="material-symbols-outlined" style="font-size:68px; color:#596d48;">
description
</span>
  </a>
...
<h3 align="center">Project: Sign Up Form</h3>
  ...
  <p align="center">
    A simple website implementing client-side form validation using built-in form validation and Javascript
    <br />
    <!-- <a href="https://github.com/github_username/repo_name"><strong>Explore the docs »</strong></a> -->
    <br />
    <br />
    <a href="https://sophiavf.github.io/Project-Sign-Up-Form/">View Demo</a>
    ·
    <a href="https://github.com/sophiavf/Project-Sign-Up-Form/issues">Report Bug</a>
    ·
    <a href="https://github.com/sophiavf/Project-Sign-Up-Form/issues">Request Feature</a>
  </p>
</div>
...
A simple website created for the [Sign-Up Form Project](https://www.theodinproject.com/lessons/node-path-intermediate-html-and-css-sign-up-form) on [The Odin Project](https://www.theodinproject.com/). It implements both built-in and custom JavaScript form validation techniques, and uses Flexbox.
...
1. Clone the repo
   ```sh
   git clone git@github.com:sophiavf/Project-Sign-Up-Form.git
   ```
...
[product-screenshot]: Project-Sign-Up-Form.png
